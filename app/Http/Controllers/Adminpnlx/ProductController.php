...
class ProductController extends Controller
{
    ...
    {
        $name = $request->name ?? '';
        $query = Product::where('admins.is_deleted', 0);
    ...
    {
        $modalDetail = Product::where('id', $id)->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        $modelDetail = Product::where('id', $id)->first();
